...
# -*- coding: utf-8 -*-
"""
Created on Mon Sep 16 00:13:08 2019
...
#ds=ds.drop(['ID', 'LSAStotal_baseline', 'extra1', 'DOB'], axis=1)
ds=ds.drop(['ID', 'LSAStotal_baseline', 'extra1', 'DOB'], axis=1)
...
for idx in range(Y.shape[1]):
    ...
    #for train, test in ShuffleSplit(n_splits=200, random_state=0, test_size=0.2, train_size=None):   
        ...
        clf1 = ExtraTreesRegressor(n_estimators=1000, max_depth=None)

        #clf1 = RandomForestRegressor(n_estimators= 500, max_depth=30, random_state=0) 
        #clf1 = SVR(kernel='rbf')

#        svr_lin = SVR(kernel='linear')
#        ridge = Ridge(random_state=1)
#        svr_rbf = SVR(kernel='rbf')
#        rf = RandomForestRegressor(n_estimators= 1000, max_depth=30, random_state=0)    
#    
        ...
        clf2 = GridSearchCV(clf1, param_grid=parameters)
